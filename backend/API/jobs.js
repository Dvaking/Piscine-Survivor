...
function fetchData() {
    return __awaiter(this, void 0, void 0, function () {
        var token, employees, customers, customer, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    token = _a.sent();
                    return [4 /*yield*/, (0, employeesApi_1.getEmployees)(token)];
                case 2:
                    employees = _a.sent();
                    return [4 /*yield*/, (0, customersApi_1.getCustomers)(token)];
                case 3:
                    customers = _a.sent();
                    return [4 /*yield*/, (0, customersApi_1.getCustomerById)(token, 1)];
                case 4:
                    customer = _a.sent();
