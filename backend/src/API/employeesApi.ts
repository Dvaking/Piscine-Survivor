...
export async function getEmployees(token: Token): Promise<AxiosResponse<EmployeeProps[]>> {
  try {
...
export async function getEmployeeMe(token: Token): Promise<AxiosResponse<EmployeeProps>> {
